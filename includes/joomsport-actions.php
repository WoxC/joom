                    ...
                    foreach($participants as $part){
                        ...
                        if($playersin && count($playersin)){
                            foreach ($playersin as $pl) {
                                ...
                                $query = 'INSERT IGNORE INTO '.$wpdb->joomsport_playerlist.'(season_id,team_id,player_id) VALUES(%d,%d,%d)';
                                $wpdb->query($wpdb->prepare($query, $this->season_id, $part, $pl));
                            }
                        }
                    }
                }
                    ...
                    foreach($participants as $part){
                        ...
                        if($playersin && count($playersin)){
                            foreach ($playersin as $pl) {
                                ...
                                $query = 'INSERT IGNORE INTO '.$wpdb->joomsport_playerlist.'(season_id,team_id,player_id) VALUES(%d,%d,%d)';
                                $wpdb->query($wpdb->prepare($query, $this->season_id, $part->ID, $pl));
                            }
                        }
                    }
                }
